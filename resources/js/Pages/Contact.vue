                    ...
                    <div class="grid md:grid-cols-2 gap-16">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 mb-8 leading-relaxed">
                                Have questions about TANFORD? We'd love to hear from you. Reach out to us using any of the methods below, and our team will get back to you as soon as possible.
                            </p>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="flex items-start gap-4">
                                    <div class="flex-shrink-0">
                                        <span class="material-icons text-emerald-600 text-2xl">mail</span>
                                    </div>
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900 mb-1">Email</h3>
                                        <a href="mailto:info@tanford.net" class="text-emerald-600 hover:text-emerald-700">info@tanford.net</a>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    <div class="flex-shrink-0">
                                        <span class="material-icons text-emerald-600 text-2xl">call</span>
                                    </div>
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900 mb-1">Phone</h3>
                                        <a href="tel:+971564864558" class="text-emerald-600 hover:text-emerald-700">+971 56 486 4558</a>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    <div class="flex-shrink-0">
                                        <span class="material-icons text-emerald-600 text-2xl">location_on</span>
                                    </div>
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900 mb-1">Address</h3>
                                        <p class="text-gray-600">Dar es Salaam, Tanzania<br />Dubai, United Arab Emirates</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    <div class="flex-shrink-0">
                                        <span class="material-icons text-emerald-600 text-2xl">schedule</span>
                                    </div>
                                    <div>
